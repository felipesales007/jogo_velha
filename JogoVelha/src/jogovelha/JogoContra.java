...
public class JogoContra extends javax.swing.JFrame 
{
    ...
    public void Vencedor(String JogadorVencedor)
    {
        ...
        {
            JOptionPane.showMessageDialog(JogoContra.this, "Parabéns Jogador 1, você venceu");
            Vitoria1 ++;
        ...
        {
            JOptionPane.showMessageDialog(JogoContra.this, "Parabéns Jogador 2, você venceu");
            Vitoria2 ++;
        ...
        {
            JOptionPane.showMessageDialog(JogoContra.this, "Empate!");
            Empate ++;
